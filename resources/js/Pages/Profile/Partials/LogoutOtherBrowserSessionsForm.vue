...
<template>
    <ActionSection>
        ...
        <template #description>
            See where you’re signed in and sign out elsewhere if you no longer trust a device.
        </template>
                    ...
                    <div class="ms-3">
                        ...
                        <div>
                            <div class="text-xs text-slate-500">
                                ...
                                <span v-if="session.is_current_device" class="text-brand-500 font-semibold">This device</span>
