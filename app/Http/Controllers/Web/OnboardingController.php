...
class OnboardingController extends Controller
{
    ...
    public function show(Request $request): Response|RedirectResponse
    {
        ...
        return Inertia::render('Onboarding/Setup', [
            ...
            'initial' => [
                ...
                'invoice_number_use_random_suffix' => (bool) ($settings['invoice_number_use_random_suffix'] ?? false),
    ...
    public function complete(Request $request): RedirectResponse
    {
        ...
        $settingsKeys = [
            ...
            'invoice_number_use_random_suffix' => (bool) $validated['invoice_number_use_random_suffix'],
